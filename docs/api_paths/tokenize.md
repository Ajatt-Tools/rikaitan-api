...
The response contains an array with parsing results from Rikaitan's internal `parseText` method. Each element in the content array represents a parsed segment with its reading(s) and text.
