...
The response contains an array with parsing results from Rikaitan's internal `parseText` method. For each result, the `index` corresponds to the index of the input text array or `0` if a string was provided.
