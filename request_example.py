...
def rikaitan_version() -> None:
    print("Requesting rikaitanVersion:")
    response = requests.post(request_url + "/rikaitanVersion", timeout = request_timeout)
    print(response)
    print(response.text)
    dump_json("rikaitanVersion", response.json())
...
print("Rikaitan API request example demo")
